...
import { AccountCircleOutlined, AdminPanelSettings, CategoryOutlined, ConfirmationNumberOutlined, DashboardOutlined, EscalatorWarningOutlined, FemaleOutlined, LoginOutlined, MaleOutlined, MonetizationOnOutlined, OutboxOutlined, SearchOutlined, VpnKeyOutlined } from "@mui/icons-material"
                            ...
                            <>
                                ...
                                {/** Products - ONLY IS LOGGED VENDOR ROLE */}
                                {
                                    (user?.role === 'vendor' || user?.role === 'admin') && (
                                        <>
                                            <ListItem button onClick={() => navigateTo('/product/managment/listProducts')}>
                                                <ListItemIcon>
                                                    <CategoryOutlined />
                                                </ListItemIcon>
                                                <ListItemText primary={'Mis Productos'} />
                                            </ListItem>
                                            <ListItem button onClick={() => navigateTo('/product/managment/mySales')}>
                                                <ListItemIcon>
